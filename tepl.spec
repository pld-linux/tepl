...
License:	LGPL v2.1+
Group:		Libraries
Source0:	http://ftp.acc.umu.se/pub/GNOME/sources/tepl/2.99/%{name}-%{version}.tar.xz
# Source0-md5:	42b00cf84cbfed6a40dc0011c42da588
...
%{__rm} $RPM_BUILD_ROOT%{_libdir}/libtepl-3.la
